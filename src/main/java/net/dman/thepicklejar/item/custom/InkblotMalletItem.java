...
public class InkblotMalletItem extends SwordItem implements Vanishable {
    ...
    public InkblotMalletItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
        ...
        builder.put(
                ...
                new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Weapon modifier", 10, EntityAttributeModifier.Operation.ADDITION)
        );
        builder.put(
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.the-pickle-jar.inkblot_mallet"));
