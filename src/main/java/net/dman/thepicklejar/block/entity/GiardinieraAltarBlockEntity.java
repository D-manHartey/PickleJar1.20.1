...
public class GiardinieraAltarBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new GiardinieraAltarScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
    ...
    private boolean hasRecipe() {
        ItemStack result = new ItemStack(ModItems.GOLDEN_PICKLE);
        boolean hasInput  = getStack(INPUT_SLOT).getItem() == ModItems.PICKLE;
